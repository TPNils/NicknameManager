 ...
 */
public class LocalMySQLTest extends DaTester
{
    public LocalMySQLTest() throws Exception
    {
        super(TestReference.getLocalSqlPlayerStorage(), TestReference.getPlayerData());
    }
