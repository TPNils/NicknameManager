...
public class ResetOtherCooldownCmd extends AbstractCmd implements IArgumentChecker
{
    ...
    public CommandResult execute(CommandSource src, CommandContext args) throws CommandException
    {
        ...
        src.sendMessage(this.getMessageController().getMessage(Reference.SuccessMessages.ADMIN_NICK_RESET_COOLDOWN).apply(TemplateUtils.getParameters(playerData)).build());
