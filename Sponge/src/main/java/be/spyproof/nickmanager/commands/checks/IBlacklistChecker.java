...
public interface IBlacklistChecker extends IMessageControllerHolder
{
    default void checkBlacklist(CommandSource src, String nickname) throws CommandException
    {
        ...
        {
            throw new CommandException(this.getMessageController().getMessage(Reference.ErrorMessages.BLACKLIST)
                                           .apply(TemplateUtils.getParameters("regex", blacklistRegex.get())).build());
        }
    }
}
