 ...
 */
public class SpongePlayerController extends CachedPlayerController implements ISpongePlayerController
{
    public SpongePlayerController(IPlayerStorage storage)
    {
        super(storage);
    }
